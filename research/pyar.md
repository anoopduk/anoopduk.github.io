...
[Explore clusters and nanoalloys]({{ '/research/clusters/' | relative_url }}) · [Explore astrochemical reaction discovery]({{ '/research/reaction-discovery/' | relative_url }}) · [Explore functional molecular discovery]({{ '/research/functional-materials/' | relative_url }}) · [Return to the research overview]({{ '/research/' | relative_url }}) · [Visit AnoopLab](https://anooplab.github.io/) · [Browse our software](https://github.com/anooplab)
